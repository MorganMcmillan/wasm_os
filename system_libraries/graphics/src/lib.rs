...
unsafe extern "C" {
    ...
    #[link_name = "set_fill_pattern"]
    fn extern_set_fill_pattern(pattern: u64);
    #[link_name = "draw_pixel"]
    fn extern_draw_pixel(x: i32, y: i32, color: Color);
    #[link_name = "draw_hline"]
    fn extern_draw_hline(x: i32, y: i32, width: u32, color: Color);
    #[link_name = "draw_vline"]
    fn extern_draw_vline(x: i32, y: i32, height: u32, color: Color);
    #[link_name = "draw_line"]
    fn extern_draw_line(x1: i32, y1: i32, x2: i32, y2: i32, color: Color);
    ...
    fn extern_draw_rectangle(x: i32, y: i32, width: u32, height: u32, color: Color);
    #[link_name = "draw_filled_rectangle"]
    fn extern_draw_filled_rectangle(x: i32, y: i32, width: u32, height: u32, color: Color);
    #[link_name = "draw_round_rectangle"]
    fn extern_draw_round_rectangle(
        x: i32,
        y: i32,
        width: u32,
        height: u32,
    ...
    fn extern_draw_circle(x: i32, y: i32, radius: u32, color: Color);
    #[link_name = "draw_filled_circle"]
    fn extern_draw_filled_circle(x: i32, y: i32, radius: u32, color: Color);
    #[link_name = "draw_ellipse"]
    fn extern_draw_ellipse(x: i32, y: i32, x_radius: u32, y_radius: u32, color: Color);
    #[link_name = "draw_filled_ellipse"]
    fn extern_draw_filled_ellipse(x: i32, y: i32, x_radius: u32, y_radius: u32, color: Color);
    #[link_name = "draw_sprite"]
    fn extern_draw_sprite(x: i32, y: i32, sprite: *const u8, spr_width: u32, spr_height: u32);
    #[link_name = "draw_text"]
    fn extern_draw_text(text_ptr: *const u8, text_len: u32, color: Color);
}
...
pub fn set_fill_pattern(pattern: u64) {
    unsafe {
        extern_set_fill_pattern(pattern);
    }
}
...
pub fn draw_hline(x: i32, y: i32, width: u32, color: Color) {
    unsafe {
        extern_draw_hline(x, y, width, color);
    }
}

pub fn draw_vline(x: i32, y: i32, height: u32, color: Color) {
    unsafe {
...
pub fn draw_rectangle(x: i32, y: i32, width: u32, height: u32, color: Color) {
    unsafe {
        extern_draw_rectangle(x, y, width, height, color);
    }
}

pub fn draw_filled_rectangle(x: i32, y: i32, width: u32, height: u32, color: Color) {
    unsafe {
        extern_draw_filled_rectangle(x, y, width, height, color);
    }
}

pub fn draw_round_rectangle(x: i32, y: i32, width: u32, height: u32, radius: u32, color: Color) {
    unsafe {
...
pub fn draw_circle(x: i32, y: i32, radius: u32, color: Color) {
    unsafe {
        extern_draw_circle(x, y, radius, color);
    }
}

pub fn draw_filled_circle(x: i32, y: i32, radius: u32, color: Color) {
    unsafe {
        extern_draw_filled_circle(x, y, radius, color);
    }
}

pub fn draw_ellipse(x: i32, y: i32, x_radius: u32, y_radius: u32, color: Color) {
    unsafe {
        extern_draw_ellipse(x, y, x_radius, y_radius, color);
    }
}

pub fn draw_filled_ellipse(x: i32, y: i32, x_radius: u32, y_radius: u32, color: Color) {
    unsafe {
...
pub fn draw_text(text: &[u8], color: Color) {
    unsafe {
